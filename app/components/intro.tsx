		...
		>
			<div className='mx-auto flex min-h-screen max-w-5xl flex-col items-center justify-center px-10 py-24 text-4xl font-semibold tracking-tight md:py-28 md:text-6xl lg:px-20 lg:py-3 lg:text-7xl'>
				<div className='leading-[1.15]'>
					...
					>
						From <span className='text-primary-500'>2.1M daily API requests</span> to{' '}
						<span className='text-primary-500'>$8.3M monthly transactions</span>—I build infrastructure that scales.
					</span>
					<span
						className='intro-text inline-block'
						style={{ opacity: opacityForBlock(progress, 2) }}
					>
						Passionate about clean code, distributed systems, and turning complex requirements into{' '}
						<span className='underline decoration-primary-500'>production-ready solutions</span>.
					</span>
				</div>
			</div>
		</div>
